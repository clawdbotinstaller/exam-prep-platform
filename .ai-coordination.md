...
- **Additional Fixes**:
  - ✅ Fixed LaTeX regex pattern to properly parse $...$ expressions (was using flawed [^$] pattern)
  - ✅ Removed 'Word Problems' and 'Series' filters from ArchiveBrowse (now: All, Integration, DiffEq)
  - ✅ Updated hero subheadline: replaced em-dashes with colon, changed "ratio test/volume of revolution" to "trig substitution/differential equation"
